...
public class PlaygroundParameter extends BaseVO {
    ...
    public PlaygroundParameter() {}

    public PlaygroundParameter(String task, String topic, String style, String tone, String audience, String length, String format) {
        this.task = task;
        this.topic = topic;
